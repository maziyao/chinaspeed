...
wav_path='C:/Users/Administrator/PycharmProjects/机器人制作/识别/train'
label_file='C:/Users/Administrator/PycharmProjects/机器人制作/识别/doc/trans/train.word.txt'
 ...
 #######################run batch####
    ...
    for batch in range(n_batches_per_epoch):#一次batch_size，取多少次
        ...
        if (batch +1)%100 == 0:
            ...
            dense_decoded = tf.sparse_tensor_to_dense( d, default_value=0).eval(session=sess)#-1改为0
