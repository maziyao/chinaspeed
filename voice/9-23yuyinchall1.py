...
wav_path='/content/drive/My Drive/识别/train'
label_file='/content/drive/My Drive/识别/doc/trans/train.word.txt'
...
epochs = 100
savedir = "/content/drive/My Drive/识别/log/yuyinchalltest/"
